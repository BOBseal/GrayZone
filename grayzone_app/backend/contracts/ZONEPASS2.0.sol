...
""      "" UPGRADEABLE = 0x9CF88E840dF94eb80e8033BB3587c212331711AC
LINEA MAINNER UPG ... = 0x66C9ECF0B4c6fd852254E27b6505493440310D23
MANTLE MAINNET UPG... = 0x88F4d79dFe18125Dd8603E3ec442e9bB2c89d8fA
FUSE     ""     ""     = 0x90a239607F06AfF86EFD27E4fa253E5A0C814692
*/
...
//import "https://github.com/LayerZero-Labs/solidity-examples/blob/main/contracts/contracts-upgradable/token/onft/ERC721/IONFT721Upgradeable.sol";
//import"https://github.com/LayerZero-Labs/solidity-examples/blob/main/contracts/contracts-upgradable/token/onft/ERC721/ONFT721CoreUpgradeable.sol";
//import"https://github.com/LayerZero-Labs/solidity-examples/blob/main/contracts/token/onft/ONFT721.sol";

contract ZONEPASS is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, ERC721BurnableUpgradeable,OwnableUpgradeable {
    ...
    function initialize(address weth , string memory name , string memory symbol) initializer public {
    ...
    function recoverData( uint256 id , uint256 slot) public payable{
        ...
        require(_zonepassmaps[id]._20bal[_feeToken] >= directFee * 5 || IERC20(_feeToken).balanceOf(msg.sender)>= directFee * 5  ,"need fee");
   ...
   function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable) returns (bool) {
